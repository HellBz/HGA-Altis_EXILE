if (hasInterface) then {
	_nul = [] spawn {
		...
		call compile preprocessFileLineNumbers "custom\plugin\A3XAI_Client\A3XAI_client_config.sqf";
		call compile preprocessFileLineNumbers "custom\plugin\A3XAI_Client\A3XAI_client_verifySettings.sqf";
		call compile preprocessFileLineNumbers "custom\plugin\A3XAI_Client\A3XAI_client_functions.sqf";
