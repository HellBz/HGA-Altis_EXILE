...
try
{
	_message = preprocessFileLineNumbers "custom\plugin\ExAdClient\XM8\Apps\Info\message.sqf";
	_message = _message select [(_message find "ExAdClient") + (count "custom\plugin\ExAdClient\XM8\Apps\Info\message.sqf") + 1];
