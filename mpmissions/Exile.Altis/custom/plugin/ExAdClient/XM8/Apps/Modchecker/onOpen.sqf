...
try
{
	_message = preprocessFileLineNumbers "custom\plugin\ExAdClient\XM8\Apps\ModChecker\xm8modChecker.sqf";
	_message = _message select [(_message find "ExAdClient") + (count "custom\plugin\ExAdClient\XM8\Apps\ModChecker\xm8modChecker.sqf") + 1];
...
#include "addon\displayConfig.hpp"
