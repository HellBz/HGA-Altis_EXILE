...
_path = "custom\plugin\ExAdClient\StatsBar\customize.sqf";
call compile preprocessFileLineNumbers _path;

if(isNil "ExAd_SB_ICON_BANK")then{ExAd_SB_ICON_BANK = "custom\plugin\ExAdClient\StatsBar\Icons\ExAd_Bank.paa";};
if(isNil "ExAd_SB_ICON_CLAN")then{ExAd_SB_ICON_CLAN = "custom\plugin\ExAdClient\StatsBar\Icons\ExAd_Family.paa";};
if(isNil "ExAd_SB_ICON_COMPASS")then{ExAd_SB_ICON_COMPASS = "custom\plugin\ExAdClient\StatsBar\Icons\ExAd_Compass.paa";};
if(isNil "ExAd_SB_ICON_GRID")then{ExAd_SB_ICON_GRID = "custom\plugin\ExAdClient\StatsBar\Icons\ExAd_Grid.paa";};
if(isNil "ExAd_SB_ICON_HP")then{ExAd_SB_ICON_HP = "custom\plugin\ExAdClient\StatsBar\Icons\ExAd_Health.paa";};
if(isNil "ExAd_SB_ICON_HUNGER")then{ExAd_SB_ICON_HUNGER = "custom\plugin\ExAdClient\StatsBar\Icons\ExAd_Hunger.paa";};
if(isNil "ExAd_SB_ICON_KD")then{ExAd_SB_ICON_KD = "custom\plugin\ExAdClient\StatsBar\Icons\ExAd_KD.paa";};
if(isNil "ExAd_SB_ICON_PLAYERS")then{ExAd_SB_ICON_PLAYERS = "custom\plugin\ExAdClient\StatsBar\Icons\ExAd_Players.paa";};
if(isNil "ExAd_SB_ICON_RESPECT")then{ExAd_SB_ICON_RESPECT = "custom\plugin\ExAdClient\StatsBar\Icons\ExAd_Respect.paa";};
if(isNil "ExAd_SB_ICON_TEMP")then{ExAd_SB_ICON_TEMP = "custom\plugin\ExAdClient\StatsBar\Icons\ExAd_Temp.paa";};
if(isNil "ExAd_SB_ICON_THIRST")then{ExAd_SB_ICON_THIRST = "custom\plugin\ExAdClient\StatsBar\Icons\ExAd_Thirst.paa";};
if(isNil "ExAd_SB_ICON_TIMER")then{ExAd_SB_ICON_TIMER = "custom\plugin\ExAdClient\StatsBar\Icons\ExAd_Restart.paa";};
if(isNil "ExAd_SB_ICON_Wallet")then{ExAd_SB_ICON_Wallet = "custom\plugin\ExAdClient\StatsBar\Icons\ExAd_Wallet.paa";};
if(isNil "ExAd_SB_ICON_LOGO")then{ExAd_SB_ICON_LOGO = "custom\plugin\ExAdClient\Core\Img\ExAd_logo_128.paa";};
