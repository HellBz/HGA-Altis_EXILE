...
ExAd_SB_ICON_BANK = 	"custom\plugin\ExAdClient\StatsBar\Icons\ExAd_Bank.paa";		//STRING - Path to bank icon
ExAd_SB_ICON_CLAN = 	"custom\plugin\ExAdClient\StatsBar\Icons\ExAd_Family.paa";	//STRING - Path to family icon
ExAd_SB_ICON_COMPASS = 	"custom\plugin\ExAdClient\StatsBar\Icons\ExAd_Compass.paa";	//STRING - Path to compass icon
ExAd_SB_ICON_GRID = 	"custom\plugin\ExAdClient\StatsBar\Icons\ExAd_Grid.paa";		//STRING - Path to grid icon
ExAd_SB_ICON_HP = 		"custom\plugin\ExAdClient\StatsBar\Icons\ExAd_Health.paa";	//STRING - Path to health icon
ExAd_SB_ICON_HUNGER = 	"custom\plugin\ExAdClient\StatsBar\Icons\ExAd_Hunger.paa";	//STRING - Path to hunger icon
ExAd_SB_ICON_KD = 		"custom\plugin\ExAdClient\StatsBar\Icons\ExAd_KD.paa";		//STRING - Path to kill death ratio icon
ExAd_SB_ICON_PLAYERS = 	"custom\plugin\ExAdClient\StatsBar\Icons\ExAd_Players.paa";	//STRING - Path to players icon
ExAd_SB_ICON_RESPECT = 	"custom\plugin\ExAdClient\StatsBar\Icons\ExAd_Respect.paa";	//STRING - Path to respect icon
ExAd_SB_ICON_TEMP = 	"custom\plugin\ExAdClient\StatsBar\Icons\ExAd_Temp.paa";		//STRING - Path to temperature icon
