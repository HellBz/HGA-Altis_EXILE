	...
	class Uniforms
	{
		...
		items[] =
		{
			#include "CUNITS\CUNITS_Uniforms.hpp"
			"U_C_Journalist",
			"U_C_Poloshirt_blue",
	...
	class Vests
	{
		...
		items[] =
		{
			#include "CUNITS\CUNITS_Vests.hpp"
			"V_Press_F",
			"V_Rangemaster_belt",
			"V_TacVest_blk",
	...
	class Headgear
	{
		...
		items[] =
		{
			#include "CUNITS\CUNITS_Headgear.hpp"
...
class Glasses
	...
	class PointerAttachments
	{
		...
		items[] =
		{
			#include "CUPW\CUPW_PointerAttachments.hpp"
			"acc_flashlight",
			"acc_pointer_IR"
		};
	};
	...
	class BipodAttachments
	{
		...
		items[] =
		{
			#include "CUPW\CUPW_BipodAttachments.hpp"
			"bipod_01_F_blk",
			"bipod_01_F_mtp",
			"bipod_01_F_snd",
			"bipod_02_F_blk",
	...
	class MuzzleAttachments
	{
		...
		items[] =
		{
			#include "CUPW\CUPW_MuzzleAttachments.hpp"
	...
	class OpticAttachments
	{
		...
		items[] =
		{
			#include "CUPW\CUPW_OpticAttachments.hpp"
			"optic_Aco",
			"optic_ACO_grn",
			"optic_ACO_grn_smg",
			"optic_Aco_smg",
	...
	class Backpacks
	{
		...
		items[] =
		{
			#include "CUNITS\CUNITS_Backpacks.hpp"
			"B_AssaultPack_blk",
			"B_AssaultPack_cbr",
			"B_AssaultPack_dgtl",
			"B_AssaultPack_khk",
	...
	class Ammunition
	{
		...
		items[] =
		{
			#include "CUPW\CUPW_Ammunition.hpp"
	...
	class Explosives
	{
		...
		items[] =
		{
			#include "CUPW\CUPW_Explosives.hpp"
			"HandGrenade",
			"MiniGrenade",
			"B_IR_Grenade",
			"O_IR_Grenade",
	...
	class SubMachineGuns
	{
		...
		items[] =
		{
			#include "CUPW\CUPW_SubMachineGuns.hpp"
			"hgun_PDW2000_F",
			"SMG_01_F",
			"SMG_02_F",
			"SMG_05_F"
	...
	class LightMachineGuns
	{
		...
		items[] =
		{
			#include "CUPW\CUPW_LightMachineGuns.hpp"
	...
	class AssaultRifles
	{
		...
		items[] =
		{
			#include "CUPW\CUPW_AssaultRifles.hpp"
			"arifle_Katiba_C_F",
			"arifle_Katiba_F",
			"arifle_Katiba_GL_F",
			"arifle_Mk20_F",
	...
	class Shotguns
	{
		...
		items[] =
		{
			#include "CUPW\CUPW_Shotguns.hpp"
			"Exile_Weapon_M1014"
		};
	};
	...
	class SniperRifles
	{
		...
		items[] =
		{
			#include "CUPW\CUPW_SniperRifles.hpp"
			"arifle_MXM_Black_F",
			"arifle_MXM_F",
			"srifle_DMR_01_F",
	...
	class Choppers
	{
		...
		items[] =
		{
			#include "CUPV\CUPV_Choppers.hpp"
