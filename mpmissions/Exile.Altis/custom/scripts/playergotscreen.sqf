...
_playerUID = getPlayerUID player;
{
	...
	[
	 ...
	 ["InfoTitleAndText", ["Territory Protection Money", format["<t color='#E48A36'>%2</t> territory payment due: <t color='#E48A36'>%1</t>",_dueDate,_name] ]] call ExileClient_gui_toaster_addTemplateToast;
    };
}
