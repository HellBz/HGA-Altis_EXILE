...
[] execVM "Custom\BuryBody\compiles.sqf";
player setVariable ['HellBzBuryBodyPermitted', false, true];
...
"EnigmaReviveMSG" addPublicVariableEventHandler {
   ...
   _msg = _packet select 0;
	...
	sleep 10;
	systemChat "Loading: HellBz Bure Body"; //Please leave this line as a way of saying thanks to me! :D HAPPYD
};