...
class CfgSettings
{
    groupsActive = 0; //All animals are equal, but some animals are more equal than others... 1 for using group feature
    liteVersion = 1; //set to 1 if you want to manage the UID list in this config instead of the Database
