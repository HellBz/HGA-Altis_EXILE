...
while {true} do
{
    ...
    else
    {
        ...
        if(_transportType == "heli") then 
        {
			...
			if((SC_occupyTransportClassToUse) == "Exile_Chopper_Orca_Black")then{_transport setObjectTextureGlobal [0, "custom\textures\orca_hga_taxi.jpg"];};
        ...
        else
        {
			...
			if((SC_occupyTransportClassToUse) == "Exile_Car_Ikarus_Blue")then{_transport setObjectTextureGlobal [0, "custom\textures\ikarus_hga_taxi.jpg"];};
        ...
        if(_transportType == "land") then
        {
            ...
            "transportLocation" setMarkerText "[HGA] BUS-Taxi";    
        }
        else
        {
            "transportLocation" setMarkerType "c_air";
            "transportLocation" setMarkerText "[HGA] AirTaxi"; 
